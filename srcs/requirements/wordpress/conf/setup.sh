...
wp core install --url="https://orahmoun.42.fr" --title="1337" --admin_name=${WP_ADMIN} --admin_password=${WP_ADMIN_PASS} --admin_email=you@example.com --path="/var/www/html" --allow-root
